...
**programar → calendaritzar → preparar → impartir → registrar el resultat real → reajustar**
...
Les aplicacions antigues continuen intactes al repositori `MarcPCasals/MarcBook`:
